...
//			realIndex--;
//			playingIndex = shuffledIndexes.get(realIndex);
//		} else if (isShuffled && realIndex - 1 < 0) {
//			realIndex--;
//			playingIndex = realIndex;
//		} else {
//			if (playingIndex - 1 >= 0)
...
//			else {
//				// set to time 0
//				timeLeftToPlay = audioQueue.get(getPlayingIndex()).getDuration();
//				return audioQueue.get(getPlayingIndex());
//			}
//
//			realIndex = playingIndex;
//		}
//		return audioQueue.get(getPlayingIndex() - 1);
//	}
